...
if (isset($_GET['sender_id'])) {
  ...
  header("location: view_messages.admin.php");
}
...
<body>
  ...
  <div class="col-div-12">
        ...
        <table>
          ...
          ?>
            <tr>
              ...
              <td>
                <a href="messages.admin.php?sender_id=<?php echo $rw['sender']; ?>" style="text-decoration: none;"><span class="fa fa-eye"></span></a>
              <a href="messages.admin.php?delete_id=<?php echo $rw['sender']; ?>" style="text-decoration: none;"><span class="fa fa-trash-alt"></span></a>
              </td>
            </tr>
          <?php
            $index++;
    ...
    <div class="page-btn">
      <?php for ($b = 1; $b <= $a; $b++) {  ?>
        <a href="messages.admin.php?page=<?php echo $b; ?>"><span><?php echo $b . " "; ?></span></a>
      <?php } ?>
      <span>&#8594;</span>
    </div>
  </div>
