...
$pdf->Cell(25, 12, 'Name', 1);
$pdf->Cell(38, 12, 'Owner', 1);
$pdf->Cell(38, 12, 'Customer', 1);
$pdf->Cell(20, 12, 'Capacity', 1);
$pdf->Cell(24, 12, 'Commission', 1);
$pdf->Cell(20, 12, 'Owner', 1);
$pdf->Cell(27, 12, 'Date', 1);
$pdf->Ln();
...
foreach ($row as $rw) {
    ...
    $pdf->Cell(25, 12, $name, 1);
    $pdf->Cell(38, 12, $own_name, 1);
    $pdf->Cell(38, 12, $cus_name, 1);
    $pdf->Cell(20, 12, $ren_cap, 1);
    $pdf->Cell(24, 12, $commission, 1);
    $pdf->Cell(20, 12, $owner, 1);
    $pdf->Cell(27, 12, $date, 1);
    $pdf->Ln();
