...
$pdf->Cell(42, 12, 'Address', 1);
$pdf->Cell(32, 12, 'Owner', 1);
$pdf->Cell(22, 12, 'Status', 1);
$pdf->Cell(17, 12, 'Capacity', 1);
$pdf->Cell(18, 12, 'Available', 1);
$pdf->Cell(18, 12, 'Price', 1);
$pdf->Cell(28, 12, 'Date', 1);
$pdf->Ln();

$property = new ManageWarehouseContr();
$row = $property->viewPropertyAdmin(0, 1, 2, 3, 4, 0, 1000000);
foreach ($row as $rw) {
    if ($rw['status'] == 0) {
        $status = "Pending";
    } elseif ($rw['status'] == 1) {
    ...
    $name = $rw['name'];
    $owner_name = $rw['first_name'] . " " . $rw['last_name'];
