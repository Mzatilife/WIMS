...
<body>
    ...
    <div class="col-div-12">
        <div class="box-8">
            <div class="content-box">
                <p>Uploaded Warehouses <a href="rejected_warehouses.admin.php"><span><b>Rejected</b></span></a> <a href="full_warehouses.admin.php"><span style="margin-right:3px;"><b>Full</b></span></a></p>
                <br />
                <table>
                    <tr>
                        <th>#</th>
                    ...
                    $row = $warehouse->viewWarehouseOwner(1, 0, $page1, 5);
    ...
    <td><img style='width:75px; height:50px; margin:0; align-content:center; border-radius:10%;' class='image' src='../uploads/" . $rw['image1'] . "'></td>";
                    ?>
                        <td>
                            <a class="btn-stall" style="text-decoration:none; font-weight: bold; " href="warehouses.admin.php?id=<?php echo $rw['warehouse_id']; ?>"><span style="">view</span></a>
                        </td>
                        </tr>
                    <?php $i++;
                    } ?>
        ...
        <div class="page-btn">
            <?php for ($b = 1; $b <= $a; $b++) {  ?>
                <a href="warehouses.admin.php?page=<?php echo $b; ?>"><span><?php echo $b . " "; ?></span></a>
            <?php } ?>
            <span>&#8594;</span>
        </div>
    </div>
