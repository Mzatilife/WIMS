...
if (isset($_GET['sender_id'])) {
  ...
  header("location: view_messages.customer.php");
}
  ...
  <div class="col-div-12">
    <div class="box-8">
      <div class="content-box">
        <p>Conversations
        <a href="messages.customer.php?sender_id=1"><span>Message Admin</span></a>
        </p>
        <br />
        <table>
          <tr>
          ...
          ?>
            <tr>
              ...
              <td>
                <a href="messages.customer.php?sender_id=<?php echo $rw['sender']; ?>" style="text-decoration: none;"><span class="fa fa-eye"></span></a>
                <a href="messages.customer.php?delete_id=<?php echo $rw['sender']; ?>" style="text-decoration: none;"><span class="fa fa-trash-alt"></span></a> 
              </td>
            </tr>
          <?php
            $index++;
    ...
    <div class="page-btn">
      <?php for ($b = 1; $b <= $a; $b++) {  ?>
        <a href="messages.customer.php?page=<?php echo $b; ?>"><span><?php echo $b . " "; ?></span></a>
      <?php } ?>
      <span>&#8594;</span>
    </div>
  </div>
