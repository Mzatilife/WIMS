...
if (isset($_SESSION['sender_id'])) {
    ...
    header("location: messages.customer.php");
}
...
<body>
    ...
    <div class="col-div-12">
                ...
                <table>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                <a href="view_messages.customer.php?delete_id=<?php echo $rw['message_id']; ?>" style="text-decoration: none;"><span class="fa fa-trash-alt"></span></a>
            </td>
                        </tr>
                    <?php
                    }
        ...
        <div class="page-btn">
            <?php for ($b = 1; $b <= $a; $b++) {  ?>
                <a href="view_messages.owner.php?page=<?php echo $b; ?>"><span><?php echo $b . " "; ?></span></a>
            <?php } ?>
            <span>&#8594;</span>
        </div>
    </div>
