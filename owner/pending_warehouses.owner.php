...
<head>
    <title>Pending Warehouses</title>
...
<body>
    ...
    <td><img style='width:75px; height:50px; margin:0; align-content:center; border-radius:10%;' class='image' src='../uploads/" . $rw['image1'] . "'></td>";
                    ?>
                        <td>
                            <?php if ($rw['status'] != 4) { ?>
                                <a href="pending_warehouses.owner.php?edit=<?php echo $rw['warehouse_id']; ?>"><span class="fa fa-edit"></span></a>
                            <?php } ?>
                            <a href="pending_warehouses.owner.php?view=<?php echo $rw['warehouse_id']; ?>"><span class="fa fa-eye"></span></a>
                        </td>
                        </tr>
                    <?php $i++;
                    } ?>
        ...
        <div class="page-btn">
            <?php for ($b = 1; $b <= $a; $b++) {  ?>
                <a href="pending_warehouses.owner.php?page=<?php echo $b; ?>"><span><?php echo $b . " "; ?></span></a>
            <?php } ?>
            <span>&#8594;</span>
        </div>
    </div>
