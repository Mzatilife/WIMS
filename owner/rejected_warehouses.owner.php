...
<body>
        ...
        <div class="box-8">
            <div class="content-box">
                ...
                <table>
                    ...
                    $row = $warehouse->viewWarehouse($user_id, 2, 2, 2, $page1, 5);
    ...
    <td><img style='width:75px; height:50px; margin:0; align-content:center; border-radius:10%;' class='image' src='../uploads/" . $rw['image1'] . "'></td>";
                    ?>
                        <td>
                            <?php if ($rw['status'] != 4) { ?>
                                <a href="rejected_warehouses.owner.php?edit=<?php echo $rw['warehouse_id']; ?>"><span class="fa fa-edit"></span></a>
                            <?php } ?>
                            <a href="rejected_warehouses.owner.php?view=<?php echo $rw['warehouse_id']; ?>"><span class="fa fa-eye"></span></a>
        ...
        <?php
        $cout = $warehouse->countOwnerWarehouse($user_id, 2, 2, 2);
