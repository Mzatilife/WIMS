...
if (isset($_POST['upload'])) {
    ...
    $st = $upload->submitWarehouse($name, $user_id, $capacity, $location, $area, $price, $_FILES['images']['name'][0], $_FILES['images']['name'][1], $_FILES['images']['name'][2], $_FILES['images']['name'][3]);
    ...
    if ($st) {
        ...
        $msg = "Warehouse submitted successfully!";
    } else {

        $msg = "Error, failure submitting warehouse!";
    }
}
?>
<!Doctype HTML>
            ...
            <div class="row">
                <div class="colu">
                    ...
                    <div class="inputBox2">
                        ...
                        <input type="text" placeholder="warehouse name i.e. Mwakiyule" pattern="[a-zA-Z ]+" name="name" required>
                    </div>
                </div>
                <div class="colu">
                ...
                <div class="colu">
                    ...
                    <div class="inputBox2">
                        ...
                        <input type="text" placeholder="District i.e. Karonga" pattern="[a-zA-Z ]+" name="district" required>
                    </div>
                </div>
                <div class="colu">
                    ...
                    <div class="inputBox2">
                        <span class="fas fa-tag"></span>
                        <input type="text" placeholder="Area i.e. Baka" pattern="[a-zA-Z ]+" name="area" required>
                    </div>
                </div>
                <div class="colu">
                    ...
                    <div class="inputBox2">
                        ...
                        <input type="number" placeholder="price / square meter" name="price" required>
                    </div>
                </div>
                <div class="colu">
                ...
                <input type="submit" name="upload" value="Submit Warehouse" class="btn-stall" style="width: 40%;">
            </div>
        </form>
    </div>
