...
if (isset($_SESSION['sender_id'])) {
    ...
    header("location: messages.owner.php");
}
                ...
                <table>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                <a href="view_messages.owner.php?delete_id=<?php echo $rw['message_id']; ?>" style="text-decoration: none;"><span class="fa fa-trash-alt"></span></a>
            </td>
                        </tr>
                    <?php
                    }
