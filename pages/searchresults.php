...
<body>
    ...
    <section style="margin-top:100px;" class="menu" id="menu">
        ...
        <div class="box-container">
            ...
            $row = $warehouse->searchProperty(1, 0, $_SESSION['search_word'], $page1, 9);
            if (!empty($row)) {
                foreach ($row as $rw) {
    ...
    <?php } else { ?>
        <p class="error_noti">Error, nothing matches your search results <span class="fa fa-frown"></span>!</p>
    <?php   } ?>
    <?php
    $cout = $warehouse->countSearchProperty(1, 0, $_SESSION['search_word']);
    ...
    <div class="page-btn">
        <?php for ($b = 1; $b <= $a; $b++) {  ?>
            <a href="searchresults.php?page=<?php echo $b; ?>"><span><?php echo $b . " "; ?></span></a>
        <?php } ?>
        <span>&#8594;</span>
    </div>
